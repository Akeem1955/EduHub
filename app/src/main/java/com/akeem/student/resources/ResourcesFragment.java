package com.akeem.student.resources;
...
import com.akeem.instructor.resources.DocumentViewer;
import com.akeem.instructor.resources.ResourcesAdapter;
import com.akeem.instructor.resources.ResourcesVideo;
...
public class ResourcesFragment extends Fragment {
    ...
    public ResourcesFragment(StudentViewModel svm, Context context) {
        ...
        binding.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (adapter.getData() == null){
                    Snackbar.make(binding.getRoot(),"No Resources Available Sorry...",Snackbar.LENGTH_SHORT).show();
    ...
    private void initializeAdapter(){
        svm.getAllResources().observe(this, uris -> {
            if(uris != null){
